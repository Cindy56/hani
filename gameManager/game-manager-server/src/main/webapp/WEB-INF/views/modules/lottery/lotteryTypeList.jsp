	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="lotteryType">
			<tr>
				...
				<td>
					<fmt:formatDate value="${lotteryType.startDate}" pattern="HH:mm:ss"/>
				</td>
				<td>
					<fmt:formatDate value="${lotteryType.endDate}" pattern="HH:mm:ss"/>
				</td>
				<td>
					${lotteryType.times}
				</td>
				...
				<td>
					${lotteryType.currentIssueNo}
				</td>
				<td>
					${lotteryType.nextIssueNo}
				</td>
