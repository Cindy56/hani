...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/contract/contractCompany/">公司列表</a></li>
		<shiro:hasPermission name="contract:company:contract:edit"><li><a href="${ctx}/contract/contractCompany/form">公司添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="contract" action="${ctx}/contract/contractCompany/" method="post" class="breadcrumb form-search">
