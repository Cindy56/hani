...
<body>
    <ul class="nav nav-tabs">
        <li class="active"><a href="${ctx}/lottery/lotteryPlayConfig/">玩法基本信息列表</a></li>
        <shiro:hasPermission name="lottery:lotteryPlayConfig:edit"><li><a href="${ctx}/lottery/lotteryPlayConfig/form">玩法基本信息添加</a></li></shiro:hasPermission>
    </ul>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach items="${page.list}" var="lotteryPlayConfig">
            <tr>
                <td><a href="${ctx}/lottery/lotteryPlayConfig/form?id=${lotteryPlayConfig.id}">
                ...
                <td>
                    ${lotteryPlayConfig.example}
                </td>
                <shiro:hasPermission name="lottery:lotteryPlayConfig:edit"><td>
