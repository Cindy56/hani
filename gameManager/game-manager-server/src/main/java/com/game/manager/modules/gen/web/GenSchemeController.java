 ...
 */
package com.game.manager.modules.gen.web;
...
import com.game.manager.modules.gen.service.GenSchemeService;
import com.game.manager.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.game.manager.modules");
		}
